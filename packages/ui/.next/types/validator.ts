...
// Validate ../../app/api/variables/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/variables">> = Specific
  const handler = {} as typeof import("../../app/api/variables/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
